...
<h1 style="font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:24px;color:maroon">REPORTS</h1>
...
<div class="col-lg-12">
	<div class="card card-outline card-danger">
		<div class="card-body">
			...
			<?php 
			$status_arr = array("Item Accepted by Shippers","Shipped","In-Transit","Arrived At Destination","Out for Delivery","Delivered"); ?>
                ...
                <button class="btn btn-sm btn-secondary mx-1 bg-gradient-secondary" type="button" id='view_report'>View Report</button>
			</div>
		...
		<div class="col-md-12 ">
			<div class="card">
				<div class="card-body">
					<div class="row">
						<div class="col-md-12">
        					<button type="button" class="btn btn-secondary float-right" style="display: none" id="print"><i class="fa fa-print"></i> Print</button>
						</div>
					</div>	
