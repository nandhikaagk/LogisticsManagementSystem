  <aside class="main-sidebar sidebar-dark-secondary elevation-4" style="background-color: grey">
    <div class="dropdown" style="background-color: #900C3F">
   	<a href="./" class="brand-link" style="background-color: 007bff">
        <?php if($_SESSION['login_type'] == 1): ?>
        <h3 class="text-center p-0 m-0"><b>Logistics</b></h3>
        <?php else: ?>
        <h3 class="text-center p-0 m-0"><b>Logistics</b></h3>
        <?php endif; ?>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item dropdown">
            <a href="front.php" class="nav-link nav-home">
              <p>
        ...
        <?php endif; ?>
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <?php 
              $status_arr = array("Item Accepted<br/>by Shipper","Shipped","In-Transit","Arrived At<br/>Destination","Out for Delivery","Delivered");
