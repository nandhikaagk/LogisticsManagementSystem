...
<h1 style="font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:24px;color:maroon">SHIPMENT DETAILS LIST</h1>

<div class="col-lg-12">
	<div class="card card-outline card-danger">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-secondary btn-flat border-secondary " href="./index.php?page=new_parcel"><i class="fa fa-plus"></i> Add New</a>
			</div>
		</div>
		<div class="card-body">
					...
					<tr>
						...
						<td class="text-center">
							...
							switch ($row['status']) {
								...
								default:
									echo "<span class='badge badge-pill badge-info'> Item Accepted by Shippers</span>";
						...
						<td class="text-center">
		                    <div class="btn-group">
		                        ...
		                        <button type="button" class="btn btn-secondary btn-flat delete_parcel" data-id="<?php echo $row['id'] ?>">
...
<script>
	...
	_conf("Are you sure to delete?","delete_parcel",[$(this).attr('data-id')])
	})
	})
